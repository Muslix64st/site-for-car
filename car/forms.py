...
class ContactForm(forms.Form):
    name = forms.CharField(label='Имя', max_length=255, help_text='укажите Ваше имя')
    email = forms.EmailField(label='Email', help_text='Электронная почта')
    content = forms.CharField(widget=forms.Textarea(attrs={'cols': 60, 'rows': 10}), help_text='Опишите Вашу проблему')
